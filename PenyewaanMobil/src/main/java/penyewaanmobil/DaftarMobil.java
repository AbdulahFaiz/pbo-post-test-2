...
public final class DaftarMobil {
    ...
    // Metode final untuk menambahkan mobil ke daftar
    public final void tambahMobil(Mobil mobil) {
        mobilList.add(mobil);
    }

    // Metode final untuk mendapatkan daftar mobil
    public final List<Mobil> getMobilList() {
        return Collections.unmodifiableList(mobilList);
    }

    // Metode final untuk mencari mobil berdasarkan nama
    ...
    // Metode final untuk mengupdate data mobil
    ...
    // Metode final untuk menghapus mobil dari daftar
    public final void hapusMobil(Mobil mobilToDelete) {
        mobilList.remove(mobilToDelete);
    }

    // Metode final untuk menampilkan mobil yang tersedia
